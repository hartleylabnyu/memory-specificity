...
for sub = 1:151
    model_name = 'fourB_oneQ_lapse_twoAlpha';
    ...
    headers = {'ID', 'sim_num', 'block_order', 'learning_trial', 'sim_choice', 'sim_approach_reward'};
    csvwrite_with_headers(['../../data/sim_data/sim_sub_choices_', model_name, '_sub_', int2str(sub_id), '.csv'], [sub_id_vec, all_sim_ids, block_order, sub_trial, sub_choices, sub_points], headers);
